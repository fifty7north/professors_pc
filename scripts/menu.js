...
if (sessionStorage.getItem("splash") == null) {
  ...
  setTimeout(() => {
    document.querySelector(".page-bg").classList.add("page-bg-fade-in");
  }, 2500);
...
document.querySelectorAll(".game-window-hover").forEach((game) => {
  ...
  game.onmouseover = (Event) => {
    let title = Event.target.parentNode.querySelector(
  ...
  game.addEventListener("mouseenter", () => {
    ...
    let imageBg1 = game.parentNode.querySelector(
      ".game-window-image-bg-accent-light-default"
    );
    let imageBg2 = game.parentNode.querySelector(
  ...
  game.addEventListener("mouseleave", () => {
    ...
    let spriteAnimationDelay = 0;
    game.parentNode
      .querySelectorAll(".menu-sprite-default")
      .forEach((sprite) => {
